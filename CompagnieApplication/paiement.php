    ...
    <section id="main" class="wrapper">
        <div class="inner">
            ...
            <div class="content">
                ...
                <h3 style="color:blue; text-align: center;">Détails du Passager</h3>
                <form method="post">
                    <div class="row gtr-uniform">
                        ...
                        <div class="col-6 col-12-xsmall">
                            ...
                            <input id="prenom-passager" type="text" name="prenomPassager" placeholder="Prénom passager" aria-label="Card Holder" aria-describedby="basic-addon1">
                        </div>
                        <div class="col-6 col-12-xsmall">
                            <label style="text-align: left;">Numéro Passeport</label>
                            <input id="numero-passeport" type="text" name="numeroPassager" placeholder="Numéro Passeport" aria-label="Card Holder" aria-describedby="basic-addon1">
                        </div>
                        <div class="col-6 col-12-xsmall">
                        ...
                        <div class="col-12">
                            <h3 style="color:blue; text-align: center;">Détails de la carte de crédit</h3>
                        </div>
