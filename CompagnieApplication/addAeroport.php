    ...
    <section id="main" class="wrapper">
        <div class="inner">
            <div class="content">
                ...
                <h1>Ajouter un nouveau Aéroport</h1>
                ...
                <form method="post">
                    <div class="row gtr-uniform">
                        ...
                        <div class="col-6 col-12-xsmall">
                            <label style="text-align: left;"><span style="color:blue;">*</span> Ville Aéroport</label>
                            <input type="text" required="required" name="ville" id="ville" value="" placeholder="ville" />
                        </div>
