    ...
    <section id="main" class="wrapper">
        <div class="inner">
            <div class="content">
                ...
                <h1>Ajouter un nouveau membre d'équipage</h1>
                <form method="post">
                    <div class="row gtr-uniform">
                        ...
                        <div class="col-12">
                            <label style="text-align: left;">Adresse<span style="color:blue;">*</span></label>
                            <input type="text" name="adresse" value="" placeholder="adresse">
                        </div>

                        <div class="col-6 col-12-xsmall">
                            <label style="text-align: left;">Salaire<span style="color:blue;">*</span></label>
                            <input type="text" name="salaire" value="" placeholder="salaire">
                        </div>

                        <div class="col-6 col-12-xsmall">
                            <label style="text-align: left;">Heures de vol<span style="color:blue;">*</span></label>
                            <input type="text" name="heureVol" value="" placeholder="Heures de vol">
                        </div>

                        <div class="col-12">
                            <label style="text-align: left;">Numéro Sécurité sociale<span style="color:blue;">*</span></label>
                            <input type="text" name="numSS" value="" placeholder="Numéro sécurité sociale">
                        </div>

                        <div class="col-12">
                            <label style="text-align: left;">Fonction<span style="color:blue;">*</span></label>
