            ...
            <div class="content">
                ...
                <form method="post">
                    <div class="row gtr-uniform">
                        ...
                        <div class="col-6 col-12-xsmall">
                            <label style="text-align: left;">Fin période<span style=" color:blue;">*</span></label>
                            <input type="date" required="required" name="fn" value="" placeholder="Fin période">
                        </div>

                        <div class="col-6 col-12-xsmall">
                            <label style="text-align: left;">Heure de départ<span style="color:blue;">*</span></label>
                            <input type="time" required="required" name="hd" value="" placeholder="Heure de départ">
                        </div>

                        <div class="col-6 col-12-xsmall">
                            <label style="text-align: left;">Heure d'arrivée<span style="color:blue;">*</span></label>
                            <input type="time" required="required" name="ha" value="" placeholder="Heure d'arrivée">
                        </div>

                        <div class="col-12">
                            <label style="text-align: left;">Numéro immatriculation de l'avion<span style="color:blue;">*</span></label>
                            <div class="select">
                                <select name="numa">
                                    <?php
                                    $mysqli = new mysqli("db", "root", "root", "db");
